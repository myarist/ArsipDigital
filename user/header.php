                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li class="nav-item dropup">
                            <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                                ...
                                ?>
                                    <img class="img-circle" src="../gambar/user/<?php echo $profil['user_foto'] ?>">
                                <?php
                                }
                                ?>
                                <span><i class="fa fa-space" aria-hidden="true"></i></span>
                                <span><i class="fa fa-space" aria-hidden="true"></i></span>
                                <span class="admin-name mini-click-non"><?php echo $_SESSION['nama']; ?> <!--[ <b>User</b> ]--> </span>
                                <i class="edu-icon edu-down-arrow"></i>
                            </a>
                            <ul role="menu" class="slideInUp author-log dropup-menu zoomIn">
                                <li><a href="profil"><span class="edu-icon edu-home-admin author-log-ic"></span>Profil</a></li>
